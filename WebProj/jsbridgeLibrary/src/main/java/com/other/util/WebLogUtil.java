...
public class WebLogUtil {
    ...
    public static void i(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, WebLogUtil.LEVEL_I);
        }
    }
    ...
    public static void d(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, WebLogUtil.LEVEL_D);
        }
    }
    ...
    public static void w(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, WebLogUtil.LEVEL_W);
        }
    }
    ...
    public static void v(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, WebLogUtil.LEVEL_V);
        }
    }
    ...
    public static void e(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, WebLogUtil.LEVEL_E);
        }
    }
...
//        buffer.append(className + ".");
    ...
    private static void printByLogType(String tag, String msg, String type) {
        switch (type) {
            case WebLogUtil.LEVEL_I:
                android.util.Log.i(tag, msg);
                break;
            case WebLogUtil.LEVEL_D:
                android.util.Log.d(tag, msg);
                break;
            case WebLogUtil.LEVEL_W:
                android.util.Log.w(tag, msg);
                break;
            case WebLogUtil.LEVEL_V:
                android.util.Log.v(tag, msg);
                break;
            case WebLogUtil.LEVEL_E:
